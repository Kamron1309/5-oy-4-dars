 // Your provided JavaScript code goes here
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function editTask(task, textElement) {
                ...
                input.className = 'task-input'; // Keep this class for styling
                ...
                function saveEdit() {
                    ...
                    renderTasks(); // Re-render to show updated text and time
                }
                ...
                input.addEventListener('keypress', function(e) {
                    if (e.key === 'Enter') {
                        saveEdit();
                        input.blur(); // Trigger blur to ensure saveEdit runs only once reliably
            ...
            function formatDate(isoString) {
                ...
                // Options for a more compact and consistent format
                const options = {
                    year: 'numeric',
                    month: 'short', // e.g., "Yan", "Fev"
                    day: 'numeric',
                    hour: '2-digit',
                    minute: '2-digit',
                    hour12: false // 24-hour format
                };
                return date.toLocaleString('uz-UZ', options); // 'uz-UZ' for Uzbek locale
            }
